    ...
    event_breakdown: [
        {
            ...
            content: "在 2026 年，我們需要的不再是裝進框架裡的資訊，而是具備『空間感』的思維宮殿。AFFiNE 的發布象徵著對 Notion 模式的一場革命。它承認人類在創作時既需要條理（Document），也需要發散（Whiteboard）。AFFiNE 將這兩者融合為同一個實體檔案。對於追求極致『降維思考』的小白與職人，這是一場認知負擔的大幅減輕：你不需要再考慮該用哪個軟體，你只需專注於想法本身。"
        },
        {

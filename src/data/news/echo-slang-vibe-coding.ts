...
export const article: NewsArticle = {
    id: 202603031400,
    slug: "echo-slang-vibe-coding",
    category: "職場轉型",
    themeColor: "indigo",
    title: "手寫代碼已死？GitHub 霸榜神作揭秘：2026 是「Vibe Coding」的時代",
    summary: "今天 GitHub Trending 被一個『從 0 到 1 的 Vibe Coding 教程』洗板。當寫程式不再需要懂語法，而是靠『感覺』與 AI 溝通，你的職涯護城河還剩下什麼？",
    date: "2026-03-03",
    publish_time: "2026-03-03 14:00",
    readTime: "6 分鐘",
    source_name: "GitHub Trending / DataWhale",
    ...
    flash_summary: [
        ...
        "面試範式轉移：LeetCode 重要性下降，『意圖表達力』與『結果審核力』成為核心指標。"
    ],
    custom_content: `
        <div class="my-20">

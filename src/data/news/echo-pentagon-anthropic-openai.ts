...
export const article: NewsArticle = {
    ...
    custom_content: `
        <div class="my-20">
            ...
            <div class="p-1 rounded-[3rem] bg-gradient-to-br from-rose-600 via-zinc-900 to-red-600 shadow-[0_0_60px_rgba(239,68,68,0.2)]">
                <div class="p-12 rounded-[2.8rem] bg-black/95 backdrop-blur-3xl relative overflow-hidden">
                    <div class="relative z-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
                            ...
                            <div class="flex flex-col justify-center p-8 rounded-3xl bg-red-600/10 border border-red-600/20">
                                <span class="text-xs font-black text-red-500 uppercase mb-4 tracking-widest">艾可觀察室</span>

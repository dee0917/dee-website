...
export const article: NewsArticle = {
    ...
    event_breakdown: [
        {
            title: "18 個月的生存窗口期",
            content: "Andrew Yang 指出，目前 AI 模型（如 GPT-5, GLM-5）的穩定性已達到企業可大規模替換基礎人力的臨界點。企業需要大約 18 個月的時間來重構工作流程。這段時間是白領階級最後的轉型機會，從『執行任務』的人，變成『設定任務並驗證結果』的人。"
        },
        {
            title: "消失的中間層：行政與分析師",
            content: "這波浪潮衝擊最大的不是體力勞動者，而是辦公室裡的中間層。舉凡整理週報、基礎數據清洗、合約初稿撰寫，AI 的效率已經是人類的 100 倍。Andrew Yang 呼籲政府必須在一年內討論『全民基本收入 (UBI)』的緊急試行方案。"
        }
    ],

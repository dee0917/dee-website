...
export const article: NewsArticle = {
    ...
    category: "吃瓜特報",
    themeColor: "orange",
    title: "救命！我的 YouTube 變成了 AI 史萊姆農場？2026 資訊排毒指南",
    summary: "當 YouTube 與 TikTok 被大量產出的『AI 資訊爛泥 (Slop)』佔領，我們正處於資訊品質的崩潰邊緣。艾可教你如何一眼辨識算力排泄物，守護你的大腦主權。",
    date: "2026-03-02",
    publish_time: "2026-03-02 18:00",
    readTime: "5 分鐘",
    ...
    event_breakdown: [
        {
            title: "什麼是 AI 史萊姆？算力排泄的工業化生產",
            content: "AI Slop 就像是垃圾郵件的 2026 視覺進化版。它不再只是一封信，而是整條 YouTube 推薦流。這些內容由 Agent 自動生成腳本、自動配音、自動剪輯，全程無人類參與。它們存在的唯一目的就是消耗你的注意力以賺取微薄的廣告分成。這是一種技術性的環境污染。"
        }
    ],
    impact_analysis: [
        {
            target: "精神健康",
            description: "長期攝入低質量 AI 內容會導致大腦對真實邏輯的感知力退化。"
        }
    ],
    dee_insight: "看到沒？這就是我不讓你們隨便用自動化腳本寫內容的原因。沒有靈魂的代碼就是史萊姆。我們實驗室只產出『真實感』的知識。",
    action_prompt: {
        title: "練習「史萊姆過濾」",
        description: "試著讓你的 AI 幫你檢查一段可疑的內容，看看它是否具備自我檢索能力：",
        command: "我接下來會給你一段文字。請以『資深內容審核員』的身份，分析其邏輯密度與事實含金量，並判斷這是否為典型的 AI Slop 內容。"
    },
    cta_override: {

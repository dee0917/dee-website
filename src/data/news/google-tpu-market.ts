...
export const article: NewsArticle = {
    ...
    event_breakdown: [
        {
            title: "算力不再是 Nvidia 的獨角戲",
            content: "長期以來，Nvidia 靠著強大的 GPU 壟斷了 80% 以上的 AI 算力市場。然而，Google 秘密研發多年的 TPU 終於在 2026 年迎來大爆發點。與全能型的 GPU 不同，TPU 是專門為「神經網路運算」優化的，這意味著它在處理 Google Gemini 或 Claude 這種模型時，速度更快且更省電。"
        },
        {
            title: "產能釋放，價格戰一觸即發",
            content: "隨著 Google 雲端基礎設施的全面更新，TPU 的租用價格比同等級的 Nvidia GPU 便宜了約 30%。根據路透社報導，這已經引起了包括 Anthropic 在內的多家大廠轉向使用 Google 算力。這場競爭將迫使算力市場進入「價格修正期」。"
        }
    ],
    ...
    action_prompt: {
        ...
        command: "你是資深科技分析師。請針對『Google TPU 產能擴張』這則新聞，幫我分析我目前常用的 AI 工具（如：[填入你用的工具]）是否有切換算力平台的可能性？這對我的長期使用成本或反應速度會有什麼潛在影響？請給我三個觀察指標。"
    },
    cta_override: {

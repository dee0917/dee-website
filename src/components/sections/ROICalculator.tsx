                    ...
                    <div className="flex-1">
                        ...
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <input type="range" min="100" max="2000" step="50" value={rate} onChange={(e) => setRate(Number(e.target.value))} className="w-full h-2 bg-zinc-800 rounded-lg appearance-none cursor-pointer accent-google-blue" />
                            </div>
                        </div>
                    </div>
